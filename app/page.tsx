...
export default function DashboardPage() {
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-lg bg-[#111a4a] px-6 py-5 mb-6">
        ...
        <div className="relative flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            ...
            <h2 className="text-[18px] sm:text-[22px] font-semibold text-white tracking-tight leading-tight">
          ...
          <div className="flex items-center gap-6 text-center sm:hidden lg:flex">
            <div>
              <p className="text-[24px] sm:text-[28px] font-bold font-mono text-white leading-none">94.3%</p>
              <p className="text-[11px] text-white/50 mt-1">Precisión</p>
            </div>
            <div className="w-px h-10 bg-white/20" />
            <div>
              <p className="text-[24px] sm:text-[28px] font-bold font-mono text-[#ec652b] leading-none">2.8s</p>
              <p className="text-[11px] text-white/50 mt-1">Por contrato</p>
            </div>
            <div className="w-px h-10 bg-white/20" />
            <div>
              <p className="text-[24px] sm:text-[28px] font-bold font-mono text-[#88deeb] leading-none">12</p>
      ...
      {/* Footer note */}
      <div className="mt-6 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-[#7c7f88]">
